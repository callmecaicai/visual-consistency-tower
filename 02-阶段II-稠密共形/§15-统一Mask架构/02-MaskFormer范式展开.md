...
下文以 DETR 展开的同等密度展开 MaskFormer / Mask2Former。核心要回答三个问题：**为什么"逐像素分类"是错的? mask classification 凭什么更根本? Mask2Former 的三个改进各自在修什么?**
...
两者合起来决定了阶段 II 的最终出口（本库中的"提示化与开放词汇"那页）：
